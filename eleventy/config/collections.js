...
const groupItemsByTaxonomyBase = async (siteLangs = null, allItems, taxonomy, taxonomySingularArray, itemsPerPage, paginatorSlugArray, sortBy, sortOrder) => {
  ...
  for (const taxonomyValue of collectionTaxonomies) {
    ...
    for (let langIndex of langIndexes) {
      ...
      const taxonomySingular = siteLangs ? taxonomySingularArray[langIndex] : taxonomySingularArray
...
const addCollectionFromModel = (collectionApi, dirs, collectionName, collectionModel, fileExt) => {
  ...
  if (sortConfig[collectionModel]) {
    collection = sortCollection(
      collection,
      sortConfig[collectionModel].sortBy,
      sortConfig[collectionModel].sortOrder
    )
  }
...
const addCollectionByTaxonomy = async (collectionApi, dirs, collectionNames = 'all', taxonomy, taxonomySingular, itemsPerPage, paginatorSlug = null, fileExt, sortBy = 'date', sortOrder = 'desc') => {
...
const addMultilingualCollection = async (collectionApi, dirs, siteLangs, defaultLang, collectionName, fileExt = defaultCollectionFormat, sortBy = 'date', sortOrder = 'desc') => {
  ...
  return sortCollection(finalCollection, sortBy, sortOrder)
}

const addMultilingualCollectionByTaxonomy = async (collectionApi, dirs, siteLangs, defaultLang, collectionNames, taxonomy, taxonomySingularArray, itemsPerPage, paginatorSlugArray, fileExt, sortBy = 'date', sortOrder = 'desc') => {
  ...
  return groupMultilingualItemsByTaxonomy(siteLangs, multilingualItems, taxonomy, taxonomySingularArray, itemsPerPage, paginatorSlugMap, sortBy, sortOrder)  
}
